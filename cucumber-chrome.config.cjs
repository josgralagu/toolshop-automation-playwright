// cucumber-chrome.config.cjs - Configuration for Chrome/Chromium
module.exports = {
  ...
  format: [
    'progress-bar',
    'html:reports/cucumber/cucumber-chrome-report.html',
    'json:reports/cucumber/cucumber-chrome-report.json'
  ],
