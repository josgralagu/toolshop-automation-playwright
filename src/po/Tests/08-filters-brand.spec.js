...
import { navigateToProductsPage, filterByBrand, validateBrandProducts, deselectBrand } from "../../../utils/commands";
import { brands } from "../../../utils/testData";
...
test.describe("Area: Filter - Filter products by brand showing only items in stock", () => {
  ...
  brands.forEach((brandName) => {
    test(`Filter by brand "${brandName}" showing only items in stock`, async ({ page }) => {
