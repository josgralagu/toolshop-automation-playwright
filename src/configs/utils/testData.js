 ...
 */
export const validProfileUpdate = { phone: "3384518342" }

/**
 * Invalid profile update data for error handling scenarios
 * Exceeds maximum phone number length constraint
 */
export const invalidProfileUpdate = { phone: "2294333810192371892738127" }
 ...
 */
export const cartConfigurations = [{ productCount: 2, quantityPerProduct: 3 }]
 ...
 */
export const subcategories = ["Hammer", "Hand Saw", "Wrench"]
